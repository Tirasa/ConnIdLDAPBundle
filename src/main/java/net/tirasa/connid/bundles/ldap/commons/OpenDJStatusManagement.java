...
/**
 * Uses the <tt>ds-pwp-account-disabled</tt> attribute to implement enable/disable.
 *
 * Setting the attribute ds-pwp-account-disabled to true will disable a users account and prevent
